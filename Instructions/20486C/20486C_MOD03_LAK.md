...
4. Under **Visual C#**, click **Web**, and then, in the result pane, click **ASP.NET Web Application**.
5. In the **Name** text box of the **New Project** dialog box, type **PhotoSharingApplication**.
6. In the **Location** text box, ensure that the location specified is **Allfiles(D):\Mod03\Labfiles**.
7. In the **New Project** dialog box, ensure that the **Create directory for solution** check box is selected, and then click **OK**.
81. In the **Select a template** list of the **New ASP.NET Web Application** dialog box, click **MVC**, and then click **OK**.
...
16. Im the **Location** drop down, select a location close to you.
17. Click on **Select** to select the server.
18. Click on **Pricing tier** and select **Basic** and then **Apply**.
19. Click **Create** to create the database.
20. Wait for the creation of the database to complete, then click the **PhotoSharingDB** database.
21. Click on **Set server firewall**.
22. Click on **Add client IP** to add your IP to the firewall and click **Save**.
23. Close the **Firewall settings** to return to the database dashboard.

24. Click on **Show database connection strings** link
