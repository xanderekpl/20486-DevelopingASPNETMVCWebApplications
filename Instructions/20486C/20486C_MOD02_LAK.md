...
21. Fill properties and data types for all members. Add rows for members if needed.
...
18. On the Quick Access Toolbar of the **PhotoSharingLDM.vsd - Microsoft Visio** window, click **Save**.
