...
13. In the **Wireframe diagram** popup, click **Metric Units**, and then click  **Create**. 
14. In the Shapes pane of the **Drawing1 - Visio** window, ensure **Dialogs** is selected.
...
24. On the drawing page of the **Drawing1 - Visio** window, double-click **Hyperlink** , and then type **Home**.
...
31. On the Quick Access Toolbar of the **Drawing1 - Visio** window, click **Save**.
