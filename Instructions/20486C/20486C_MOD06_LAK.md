...
5. In the **Name** box, type **PhotoSharingTests**, and then click **OK**.
6. In the Solution Explorer pane of the **PhotoSharingApplication - Microsoft Visual Studio** window, under PhotoSharingTests, right-click **References**, and then click **Add Reference**.
7. In the navigation pane of the **Reference Manager - PhotoSharingTests** window, click **Projects**, and then click **Solution**.
8. In the result pane, select the check box corresponding to **PhotoSharingApplication**, and then click **OK**.
9. In the **PhotoSharingApplication - Microsoft Visual Studio** window, click the **Tools** menu, then **NuGet Package Manager** submenu, then **Package Manager Console** to open the NuGet Console.
10. In the **Package Manager Console** In the **Default project** box, ensure that **PhotoSharingTests** is selected.
11. In the **Package Manager Console** type the following to add the ASP.net MVC references.
  ```cs
