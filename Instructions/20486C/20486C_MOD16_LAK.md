...
1. Navigate to **Allfiles(D):\Mod16\Labfiles\Starter\PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
3. In the left pane of the **Microsoft Azure** page, click on **new** and then select **WEB APP** icon.
5. In the **Name** box of the **Create Web App** dialog box, type _&lt;your username&gt;_ **PhotoSharing**.
