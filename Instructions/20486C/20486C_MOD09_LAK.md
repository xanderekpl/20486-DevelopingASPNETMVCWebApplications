...
2. In the Libraries window, navigate to **Allfiles/20486C/Mod09/Labfiles/Starter/PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln.**
...
27. On the Welcome to Adventure Works Photo Sharing page, click **All Photos**.
28. Under Sample Photo 1, click **Display**.
...
30. In the Windows Internet Explorer window, click **Close**.
...
12. On the Welcome to Adventure Works Photo Sharing page, click **All Photos**.
13. Under Sample Photo 1, click **Display**, and then, on the Welcome to Adventure Works Photo Sharing page, note that the two comments are displayed.
...
16. In the Windows Internet Explorer window, click **Close**.
...
2. On the Welcome to Adventure Works Photo Sharing page, click **Tools**, and then click **F12 developer tools**.
...
5. On the Welcome to Adventure Works Photo Sharing page, click **All Photos**.
6. When the page is fully loaded, in the developer window, click **Stop capturing**.
7. In the **URL** column of the developer window, click **http://localhost:[port]/Photo**, and then click **Go to detailed view**.
...
10. On the Welcome to Adventure Works Photo Sharing page, click **All Photos**.
11. When the page is fully loaded, in the developer window, click **Stop capturing**.
12. In the **URL** column of the developer window, click **http://localhost:[port]/Photo**, and then click **Go to detailed view.**
13.  On the **Timings** tab, click the **Request** entry, and then, in the **Duration** column, note that the time taken is reduced.
14. In the Windows Internet Explorer window, click **Close**.
...
4. On the Welcome to Adventure Works Photo Sharing page, click **All Photos**.
5. When the page is fully loaded, in the developer window, click **Stop capturing**.
6. In the **URL** column of the developer window, click **http://localhost:[port]/Photo**, and then click **Go to detailed view**.
...
9. On the Welcome to Adventure Works Photo Sharing page, click **All Photos**.
10. When the page is fully loaded, in the developer window, click **Stop capturing**.
11. In the **URL** column of the developer window, click **http://localhost:[port]/Photo**, and then click **Go to detailed view**.
...
14. In the Windows Internet Explorer window, click **Close**.
15. In the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Close**.
