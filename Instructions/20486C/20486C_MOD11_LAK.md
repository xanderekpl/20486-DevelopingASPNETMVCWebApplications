...
9. In the **Server admin login** text box, type _&lt;your first name&gt;_.
10. In the **Password** text box, type **Pa$$w0rd**.
11. In the **Confirm Password** text box, type **Pa$$w0rd**.
12. In the **Location** box, click _&lt;a region close to you&gt;_.
...
10. In the Windows Microsoft Edge window, click **Close**.
...
7. In the Windows Microsoft Edge window, click **Close**.
8. On the **Debugging** menu, click **stop debugging** and then click **Close** on the **PhotoSharingApplication-Microsoft Visual Studio** page.
