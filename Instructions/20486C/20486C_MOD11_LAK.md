...
16. Wait until the database is created (as can be seen by clicking on the bell icon at the top right).
...
10. In the Windows Internet Explorer window, click **Close**.
