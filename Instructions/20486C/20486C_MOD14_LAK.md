...
2. In the **Libraries** window, go to **Allfiles/20486C/Mod14/Labfiles/Starter/PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
2. In the Address bar of the Internet Explorer window, type **http://localhost:&lt;yourportnumber&gt;/api/photos/4**, and then press Enter.
