...
1. In the lower section of the **My Keys - Bing maps | Dev Center** page, select the key corresponding to **Photo Sharing Application**, right-click the key, and then click **Copy**.
2. Switch to the **PhotoSharingApplication - Microsoft Visual Studio** window.
3. In the **MapDisplay.js** file, locate the following code.

  ```cs
       Credentials:"{Your Bing Key}"
```
4. Delete the text **{Your Bing Key}**.
5. Place the cursor between the opening quotation mark and the closing quotation mark, and then on the **EDIT** menu of the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Paste**.
6. On the **FILE** menu of the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Save All**.
7. On the **DEBUG** menu of the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Start Debugging**.
8. On the **Welcome to Adventure Works** page, click **Map**.

    >**Note:** On the **Map** page, the Bing Map AJAX control is displayed. However, there are no push pins on the map.

9. In the Internet Explorer window, click **Close**.
