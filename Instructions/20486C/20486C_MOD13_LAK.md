...
b. Go to **Allfiles(D):\Mod13\Labfiles\PhotoSharingApplication_13_begin\PhotoSharingApplication**, and then paste the **web.config** file.  

### Exercise 1: Accessing Microsoft Azure and Bing Maps

#### Task 1: Install the Windows Azure SDK.

1. In the **File Explorer** window, go to **Allfiles(D):\Mod13\Labfiles\Azure SDK 3.0**.
...
2. Click on **Click _here_ to create a new key**.
...
7. In the **Roles** box of the **New Windows Azure Cloud Service** dialog box, click **WCF Service Web Role**, click the **Right Arrow** button, and then click **OK**.
...
11. Wait for deployment to finish, then on the left pane click on **All resources**, then locate _&lt;Your Windows Live account name&gt;_ **LocationService** and click on it.
