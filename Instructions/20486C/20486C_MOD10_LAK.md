...
2. In the **Libraries** window, go to **Allfiles/20486C/Mod10/Labfiles/Starter/PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
12. On the **Adventure Works Photo Sharing** page, click **Tools**, and then click **F12 developer tools**.
13. On the **Cache** menu of the developer window, click **Clear browser cache**.
14. A message **Are you sure you want to clear the browser cache?** displays. Click **Yes** to clear the browser cache.
15. On the **File** menu of the developer window, click **Exit**.
16. On the **Adventure Works Photo Sharing** page, click **Slideshow**.
...
8. On the **Adventure Works Photo Sharing** page, click **Tools**, and then click **F12 developer tools**.
...
12. On the **Adventure Works Photo Sharing** page, click **Slideshow**.
...
2. On the **Adventure Works Photo Sharing** page, click **Tools**, and then click **F12 developer tools**.
3. On the **Cache** menu of the developer window, click **Clear browser cache**.
4. A message **Are you sure you want to clear the browser cache?** displays. To clear the browser cache, click **Yes**.
5. On the **File** menu of the developer window, click **Exit**.
6. On the **Adventure Works Photo Sharing** page, click **Slideshow**.
