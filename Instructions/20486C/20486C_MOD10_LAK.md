...
2. In the **Libraries** window, go to **Allfiles(D):\Mod10\Labfiles\Starter\PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
4. In the **Add Existing Item – PhotoSharingApplication** dialog box, go to **Allfiles(D):\Mod10\Labfiles\Slide Show View**, click **SlideShow.cshtml**, and then click **Add**.
...
12. On the **Adventure Works Photo Sharing** page, click the **Tools** button, and then click **F12 developer tools**.
...
16. On the **Adventure Works Photo Sharing** page, click the **Slideshow** link.
