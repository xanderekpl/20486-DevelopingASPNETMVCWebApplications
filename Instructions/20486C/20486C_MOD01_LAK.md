...
2. In the **Open Project** dialog box, navigate to **Allfiles(D):\Mod01\Labfiles\PhotoSharingSample**, click **PhotoSharingSample.sln**, and then click **Open**.
...
8. In the **http://localhost:[port]/TestPage.cshtml** window, click the **Close** button.
...
6. On the dialog that pops select **Web Forms** template and click **OK**.
...
8. In the **http://localhost:[port]/Contact.aspx** window, click the **Close** button.
...
9. In the **http://localhost:[port]/Default.aspx** window, click the **Test Page** link to view the newly created Web Form page.

   >**Note:** The text, &quot;This is a Test Page&quot;, is displayed on the Web Form page.

10. In the **http://localhost:[port]/TestPage.aspx** window, click the **Close** button.
...
4. In the **http://localhost:[port]/** window, click the **Test Page** link, and then note that the standard site layout and styles have been applied to the page.
5. In the **http://localhost:[port]/TestPages.aspx** window, click the **Close** button.
...
9. In the **http://localhost:[port]/Home/Contact** window, click the **Close** button.
...
7. In the **http://localhost:[port]/** window, click the **Test Page** link.
8. In the **http://localhost:[port]/home/TestPage** window, note that the standard site layout and styles have been applied.
9. In the **http://localhost:[port]/home/TestPage** window, click the **Close** button.
