...
3. In the **http://localhost:[port]/TestPage.aspx** window, click **Home**.
4. In the **http://localhost:[port]/** window, click **Test Page**, and then note that the standard site layout and styles have been applied to the page.
5. In the **http://localhost:[port]/TestPages.aspx** window, click **Close**.
6. In the **TestWebFormsApplication – Microsoft Visual Studio** window, click **Close**.
...
13. In the **http://localhost:[port]/** window, click **Test Page** to view the newly created page.
...
7. In the **http://localhost:[port]/** window, click **Test Page**.
8. In the **http://localhost:[port]/home/TestPage** window, note that the standard site layout and styles have been applied.
9. In the **http://localhost:[port]/home/TestPage** window, click **Close**.
10. In the **TestMVCApplication - Microsoft Visual Studio** window, click **Close**.
