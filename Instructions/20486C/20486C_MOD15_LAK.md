...
9. In the **Name** column, if there is a database named **PhotoSharingDB** then click **PhotoSharingDB** and go to step 24. If there is no database named **PhotoSharingDB** then do steps 10-24.
...
25. Click **Show database connection strings**. 
