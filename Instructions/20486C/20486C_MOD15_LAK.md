...
6. On the **Publish** page of the Publish Web wizard, click the right arrow next to **Folder**, select  **Import profile**, and then click **Publish**.
7. In the **Import Publish Settings File** dialog box, click _&lt;your username&gt;_ **PhotoSharing.azurewebsites.net.PublishSettings**, and then click **Open**.
