...
3. In the left pane of the **Microsoft Azure** page, click **New**, and then select the **Web App** icon.
...
10. To create the database, click **Create**.
list on the **Create Web App** dialog box, select **Create new App Service plan**, and then in the **REGION** box, click _&lt;A region near you&gt;_.
