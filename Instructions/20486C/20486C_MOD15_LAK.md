...
48. On the taskbar, click the **SQL Databases – Microsoft Azure – Windows Internet Explorer** icon.
49. In the Internet Explorer window, click **New Tab**.
50. In the Address bar of the Internet Explorer window, type **https://www.bingmapsportal.com**, and then click **Go to**.
51. On the **Home – Bing Maps | Dev Center** page, click **Sign In**.
...
54. In the My Keys section of the **Bing Maps | Dev Center** page, select the key corresponding to **Photo Sharing Application**, right-click the key, and then click **Copy**.
