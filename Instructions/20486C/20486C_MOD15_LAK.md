...
4. In the **App name** box of the **Create Web App** page, type _&lt;your username&gt;_ **PhotoSharing**.
5. In the **Create Web App** page, click **App Service plan/Location**.  
6. In the **App Service plan** page, click **Create new**. 
7. In the **New App Service Plan** page, in the **App Service plan** text box, type _&lt;your first name&gt;_ **PhotoSharing**.
8. In the **Location** drop down, select a location close to you.
9. Click **Pricing tier**, select **D1 Shared**, and then click **Select**.
10. In the **New App Service Plan** page, click **OK**.
11. In the **Create Web App** page, click **Create**.
