...
2. Go to **Allfiles\20486c\Mod04\Democode\OperasWebsites_04_begin**, and then double-click OperasWebSites.sln.
...
2. In the **Scaffold** dialog box, click **MVC 5 controller - Empty**.
...
17. If the **Microsoft Visual Studio** dialog box is dispalyed, note that the message, **Save changes to the following items?**, click **Yes**.
