...
6. Ensure that the **Use a layout or master page** check box and **Create as a partial view** checkbox are cleared, and then click **Add**.
...
```
12. On the toolbar of the **PhotoSharingApplication - Microsoft Visual Studio** window, click **Save Views\Photo\Index.cshtml(Ctrl+S)**.
