...
2. In the **Libraries** window, navigate to **Allfiles(D):\Mod05\Labfiles\Starter\PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
6. In the **Template** box, ensure that **Empty (witout model)** is selected.
