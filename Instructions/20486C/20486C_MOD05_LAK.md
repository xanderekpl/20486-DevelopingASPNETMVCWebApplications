...
2. In the **Libraries** window, navigate to **Allfiles/20486C/Mod05/Labfiles/Starter/PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
6. Ensure that the **Create as a partial view** and **Use a layout or master page** check boxes are clear, and then click **Add**.
...
```
10. On the toolbar of the PhotoSharingApplication - Microsoft Visual Studio window, click **Save Views\Shared_PhotoGallery.cshtmal(Ctrl+S)**.
...
7. Ensure that the **Use a layout or master page** check box and **Create as a partial view** checkbox are cleared, and then click **Add**.
...
3. In the **Controller name** box of the **Add Controller** dialog box, type **HomeController**.
