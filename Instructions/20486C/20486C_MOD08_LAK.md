...
7. On the Address bar of the Microsoft Edge window, click **Refresh (F5)**, and then note that the home page of the web application opens without problems in the mobile view.
