...
5. In the **Libraries** window, go to **Allfiles (D):\Labfiles\Mod07\Starter\PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
8. In the **Add Existing Item – PhotoSharingTests** dialog box, go to **Allfiles (D):\Labfiles\Mod07\Fake Http Classes**, click **FakeHttpClasses.cs**, and then click **Add**.
