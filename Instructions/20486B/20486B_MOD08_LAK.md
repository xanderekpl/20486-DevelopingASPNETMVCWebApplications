...
5. In the **Libraries** window, go to **Allfiles (D):\Labfiles\Mod08\Starter\PhotoSharingApplication** ,and thendouble-click **PhotoSharingApplication.sln**.
...
2. In the **PhotoSharingApplication** dialog box, go to **Allfiles (D):\Labfiles\Mod08 \Expression Web Mock Up**, and then double-click** default.html**.
...
5. In the **Add Existing Item - PhotoSharingApplication** dialog box, go to **Allfiles (D):\Labfiles\Mod08\Expression Web Mock Up\Content**, click **PhotoSharingStyles.css**, and then click **Add**.
...
```
4. In the **DIV** element of the **_PhotoGallery.cshtml** window, lcate the following code.
...
9. On the **File** menuof the developer tools window, click **Exit**.
