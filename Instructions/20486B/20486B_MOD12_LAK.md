...
6. In the **Libraries** window, go to **Allfiles (D:)\Labfiles\Mod12\Starter\PhotoSharingApplication**, and then double-click **PhotoSharingApplication.sln**.
...
8. In the **sitemap** code window, lcate the following code.
