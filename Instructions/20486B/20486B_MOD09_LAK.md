...
9. In the **Add Existing Item - PhotoSharingApplication** dialog box, navigate to **Allfiles(D):\Mod09\Labfiles\Comment Components**, click **Delete.cshtml**, and then click **Add**.
10. In the Solution Explorer pane, right-click **Controllers**, point to **Add**, and then click **Existing Item**.
11. In the **Add Existing Item - PhotoSharingApplication** dialog box, navigate to **Allfiles(D):\Mod09\Labfiles\Comment Components**, click **CommentController.cs**, and then click **Add**.
