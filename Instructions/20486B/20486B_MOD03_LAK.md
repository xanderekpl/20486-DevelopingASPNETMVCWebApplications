...
```
9. At the end of the **PhotoSharingContext** class, type the following code.
...
13. Ensure that the **ENABLE LATEST SQL DATABASE UPDATE (V12)** check box is checked, and then click **Complete** (the V icon).
