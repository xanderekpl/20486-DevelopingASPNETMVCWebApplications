...
```
8. Place the mouse cursor at the end of the **&lt;/p%gt;** tag corresponding to the **UserName** property, press Enter twice, and then type the following code.
...
8. In the Solution Explorer pane, drag the **\_PhotoGallery.cshtml** file from the Photo folder to the Sharedfolder.
...
8. In the **Choose File to Upload** dialog box, navigate to **Allfiles (D):\Labfiles\Mod05\SamplePhotos**_._
